...
def improved_source():
    ...
    for page_num in range(1,11):
        ...
        print(f'MUBI via Jina (stable safe dual format): page {page_num}: {target}')
    ...
    if not all_items: raise RuntimeError('Stable MUBI extraction returned no film links.')
    print('MUBI source ranking captured (stable Jina fallback):')
